...
* The Android code (Flutter project configured for Android): https://github.com/Orange-OpenSource/BaahBox-Flutter
...
you can :
* download the android apk [here](https://github.com/frederiquepinson/BaahBox-Flutter/releases/),
