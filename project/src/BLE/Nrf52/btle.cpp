...
void btleClass::init(char *inputDeviceName)
{
  ...
  Serial.println("begin of NRF52 btle Init");
  ...
  Bluefruit.setName(inputDeviceName);   // Check bluefruit.h for supported values
  ...
  Serial.println("end of btle NRF52 Init");
...
void btleClass::startAdvertising(void)
{
  // Advertising packet
